...
MSG_ADMIN_ACTION_USER_NOTIFIED = "Request ID {request_id} status set to {new_status}. User notified."
MSG_ADMIN_ACTION_USER_NOTIFIED_WITH_NOTE = (
    "Request ID {request_id} status set to {new_status} with note. User notified."
)
...
# Format elements in admin action views
...
PROMPT_MEDIA_NAME_ENTER = "✍️ please type the name of the media you're looking for. you can cancel using the main menu."
PROMPT_MEDIA_NAME_TOO_SHORT = "✍️ your search query is too short. please try a more specific name."

# Media manual request
PROMPT_MEDIA_MANUAL_REQUEST = (
    "✍️ okay, you chose 'other / not found'.\nplease describe the media you're looking for (e.g., title, year, any"
    ' details). your original search term was: "{original_query}".\nthis will be sent as a manual request.'
)

# Media search errors
MSG_MEDIA_ERROR_GENERIC = "❗ oops! an error occurred. please try searching again."
MSG_MEDIA_ERROR_DETAILS = "🔎❗ sorry, i couldn't fetch details. please try another selection or search again."

# Media confirmation
MSG_MEDIA_CONFIRM = "🎯 confirm: do you want to request this?"

# Button labels for media search
